...
public class FlappyBird extends ApplicationAdapter {
	...
	public void create () {
        ...
        prf = Gdx.app.getPreferences("com.artyom.flappybird");
        highscore = prf.getInteger("highscore", 0);
	...
	public void render () {
        ...
        if (gameState == 1) {
            ...
            if (!wantToSeeThis) {
                ...
                glyphLayout.setText(font, "Highscore: " + String.valueOf(highscore));
                font.draw(batch, glyphLayout,
                        Gdx.graphics.getWidth() / 2 - glyphLayout.width / 2,
